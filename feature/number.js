 ...
 */
import { parse, lookup, next, err, idx, cur } from '../parse/pratt.js';
...
// 0-9: when there's already a token, return undefined (decline) to let outer loop handle via ASI or error
