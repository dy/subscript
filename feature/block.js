...
import { expr, skip, space, lookup, err, parse, seek, cur, idx, parens } from '../parse/pratt.js';
...
export const infix = (op, prec, map, c = op.charCodeAt(0), l = op.length, prev = lookup[c]) =>
  lookup[c] = (a, curPrec, curOp, from = idx) =>
    a &&
    (curOp ? op == curOp : (l < 2 || cur.substr(idx, l) == op) && (curOp = op)) &&
    curPrec < prec &&
