...
For features you implement, please add tests, update SPECIFICATION.md and README.md if relevant, as well as REPL. Make sure tests pass. Make sure it doesn't degrade performance or bloats the code.
